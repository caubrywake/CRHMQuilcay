...
load('CRHM\output\v9\Cuchi_20230823.mat', 'basinflow','basingw', 'icemelt','time')
...
et(:,i)       = sum(D.data(:,61:79),2);
rr(:,i)      = sum(D.data(:,80:98),2);
gw(:, i)      = sum(D.data(:,99:end), 2);
S(:,i)= B(:,i)+G(:,i);
if i == 1
time = D.data(:,1);
end 
...
save ('ImportedScenarios_hourly.mat', 'time', 'B', 'G', 'S', 'b','g','s', 'snowmelt', 'firnmelt','icemelt','gw','rr', 'et');
...
indicesWith2_t4 = find(contains(fileName, '2glac') & contains(fileName, 't_4'));
...
indicesWith2_p11 = find(contains(fileName, '2glac') & contains(fileName, 'precip_11'));
...
% Common properties
xLimits = [datetime('26-Jun-2014') datetime('01-Apr-2020')];
yLimits = [0 5];
...
p1 = plot(timem, S(:, id), 'b', 'linewidth', lwcol);
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(a) No Ice, Ppt: 80%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
lgd = legend('0','1','2','3','4','5', 'bl','orientation','horizontal', 'Location', legendLocation, 'NumColumns',4);
lgd.Position = [0.1270, 0.9454, 0.2691, 0.049]; % Adjust position as necessary
legend('boxoff');
box on;
grid on;
...
title(['(b) No Ice, Ppt: 80-120%, Ta: 0 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
lgd = legend('80','90','100','110','120', 'bl','orientation','horizontal', 'Location', legendLocation, 'NumColumns',4);
lgd.Position = [0.5698, 0.9469, 0.3189, 0.0499]; % Adjust position as necessary
legend('boxoff');
box on;
grid on;
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(c) No Ice, Ppt: 100%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(d) No Ice, Ppt: 80-120%, Ta: +2 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(e) No Ice, Ppt: 120%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(f) No Ice, Ppt: 80-120%, Ta: +5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
p1 = plot(timem, S(:, id), '-k', 'linewidth', lwcol);
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(a) 13% GC, Ppt: 80%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
lgd = legend('0','1','2','3','4','5', 'bl','orientation','horizontal', 'Location', legendLocation, 'NumColumns',4);
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(b) 13% GC, Ppt: 80-120%, Ta: 0 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
lgd = legend('80','90','100','110','120', 'bl','orientation','horizontal', 'Location', legendLocation, 'NumColumns',4);
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(c) 13% GC, Ppt: 100%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(d) 13% GC, Ppt: 80-120%, Ta: +2 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(e) 13% GC, Ppt: 120%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash);
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(f) 13% GC, Ppt: 80-120%, Ta: +5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
subplot(3,2,1); hold on
id = indicesWith2_p80;
p1 = plot(timem, S(:, id), 'b', 'linewidth', lwcol); hold on
plot(t, s, ':k', 'linewidth', lwdash)
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(a) 2% GC, Ppt: 80%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
lgd = legend('bl','0','1','2','3','4','5', 'Cur, NoIce','orientation','horizontal', 'Location', legendLocation, 'NumColumns',4);
lgd.Position = [0.1270, 0.9454, 0.2691, 0.049]; % Adjust position as necessary
legend('boxoff');
box on;
grid on;
...
plot(t, s, ':k', 'linewidth', lwdash)
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(b) 2% GC, Ppt: 80-120%, Ta: 0 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
lgd = legend('baseline','80','90','100','110','120','orientation','horizontal', 'Location', legendLocation, 'NumColumns',4);
lgd.Position = [0.5698, 0.9469, 0.3189, 0.0499]; % Adjust position as necessary
legend('boxoff');
box on;
grid on;
...
plot(t, s, ':k', 'linewidth', lwdash)
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(c) 2% GC, Ppt: 100%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash)
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(d) 2% GC, Ppt: 80-120%, Ta: +2 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash)
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(e) 2% GC, Ppt: 120%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(t, s, ':k', 'linewidth', lwdash)
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(f) 2% GC, Ppt: 80-120%, Ta: +5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
%% with likley scenario highlighted
close all
lwcol = 0.8;
lwdash = 1.2;
...
p1 = plot(timem, S(:, id), 'b', 'linewidth', lwcol); hold on
plot(t, s, ':k', 'linewidth', lwdash)
plot(timem, S(:, id(4)), 'k', 'linewidth', lwcol); hold on
plot(timem, S(:, id(5)), 'k', 'linewidth', lwcol); hold on
set(p1, {'Color'}, num2cell(colorsRGB_red, 2));
title(['(c) 2% GC, Ppt: 110%, Ta: +0-5 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
plot(timem, S(:, id(5)), 'k', 'linewidth', lwcol); hold on
set(p1, {'Color'}, num2cell(colorsRGB_blue, 2));
title(['(d) 2% GC, Ppt: 80-120%, Ta: +4 ' degC 'C'], 'FontWeight', 'normal');
ylabel('Monthly Flow (m^3 s^{-1})');
xlim(xLimits);
ylim(yLimits);
box on;
...
figname = 'Scenario_2Ice_6subplot_withlikely';
saveas(gcf, strcat(figdir, figname, '.pdf'));
saveas(gcf, strcat(figdir, figname, '.png'));
savefig(gcf, strcat(figdir, figname));
